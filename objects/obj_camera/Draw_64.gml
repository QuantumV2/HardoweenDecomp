...
if (obj_player.state != (54 << 0))
{
    if (obj_player.character == "P")
    {
        if (obj_player.sprite_index == spr_knightpep_thunder)
            draw_sprite_ext(spr_pepinoHUDthunder, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player.sprite_index != spr_knightpep_start && (obj_player.state == (23 << 0) || obj_player.state == (17 << 0)))
        ...
        else if (obj_player.state == (91 << 0) || (obj_player.state == (76 << 0) && shake_mag > 0))
            draw_sprite_ext(spr_pepinoHUDstun, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player.sprite_index == spr_player_victory || obj_player.state == (55 << 0) || obj_player.state == (61 << 0) || obj_player.state == (22 << 0) || (obj_player.state == (53 << 0) && obj_player.sprite_index == spr_player_levelcomplete))
        ...
        else if (obj_player.state == (68 << 0) || obj_player.state == (32 << 0) || obj_player.state == (90 << 0) || obj_player.state == (73 << 0) || obj_player.state == (56 << 0) || obj_player.state == (62 << 0) || obj_player.state == (41 << 0) || obj_player.state == (64 << 0) || obj_player.state == (45 << 0) || obj_player.state == (46 << 0) || obj_player.state == (50 << 0) || obj_player.state == (47 << 0) || obj_player.state == (48 << 0) || obj_player.state == (49 << 0))
            draw_sprite_ext(spr_pepinoHUDmach1, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player.state == (69 << 0) || obj_player.sprite_index == spr_player_dive || obj_player.sprite_index == spr_player_machslideboost || obj_player.state == (16 << 0) || obj_player.state == (21 << 0) || obj_player.state == (42 << 0))
            draw_sprite_ext(spr_pepinoHUDmach2, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player.state == (89 << 0) && obj_player.sprite_index == spr_player_crazyrun)
            draw_sprite_ext(spr_pepinoHUDmach4, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player.state == (89 << 0) || obj_player.sprite_index == spr_player_machslideboost3)
            draw_sprite_ext(spr_pepinoHUDmach3, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player.state == (72 << 0) || obj_player.sprite_index == spr_bombpep_end || obj_player.sprite_index == spr_player_fireassend || obj_player.state == (35 << 0) || obj_player.state == (26 << 0) || (obj_player.state == (53 << 0) && obj_player.sprite_index == spr_player_bossintro) || (obj_player.state == (53 << 0) && obj_player.sprite_index == spr_player_idle))
    ...
    if (obj_player.character == "N")
    {
        ...
        else if (obj_player.sprite_index != obj_player.spr_knightpepstart && (obj_player.state == (23 << 0) || obj_player.state == (17 << 0)))
        ...
        else if (obj_player.sprite_index == obj_player.spr_victory || obj_player.state == (55 << 0) || obj_player.state == (61 << 0) || obj_player.state == (22 << 0) || (obj_player.state == (53 << 0) && obj_player.sprite_index == obj_player.spr_player_levelcomplete))
        ...
        else if (obj_player.state == (69 << 0) || obj_player.sprite_index == obj_player.spr_dive || obj_player.sprite_index == obj_player.spr_machslideboost || obj_player.state == (16 << 0) || obj_player.state == (21 << 0) || obj_player.state == (42 << 0))
            draw_sprite_ext(spr_noiseHUD_mach2, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player.state == (89 << 0) && obj_player.sprite_index == obj_player.spr_crazyrun)
            draw_sprite_ext(spr_noiseHUD_crazyrun, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player.state == (89 << 0) || obj_player.sprite_index == obj_player.spr_mach3boost)
            draw_sprite_ext(spr_noiseHUD_mach3, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player.state == (72 << 0) || obj_player.sprite_index == obj_player.spr_bombpepend || obj_player.sprite_index == obj_player.spr_fireassend || obj_player.state == (35 << 0) || obj_player.state == (26 << 0) || (obj_player.state == (53 << 0) && obj_player.sprite_index == obj_player.spr_player_bossintro) || (obj_player.state == (53 << 0) && obj_player.sprite_index == obj_player.spr_idle))
    ...
    shader_reset()
    if (obj_player.movespeed < 2.4 || (!((obj_player.state == (68 << 0) || obj_player.state == (69 << 0) || obj_player.state == (89 << 0) || obj_player.state == (16 << 0) || obj_player.state == (70 << 0) || obj_player.state == (36 << 0) || obj_player.state == (21 << 0)))))
        draw_sprite_ext(spr_speedbar, 0, 125, 140, 1, 1, 1, c_white, alpha)
    else if (obj_player.movespeed >= 2.4 && obj_player.movespeed < 4.8 && (obj_player.state == (68 << 0) || obj_player.state == (69 << 0) || obj_player.state == (89 << 0) || obj_player.state == (16 << 0) || obj_player.state == (70 << 0) || obj_player.state == (36 << 0) || obj_player.state == (21 << 0)))
        draw_sprite_ext(spr_speedbar, 1, 125, 140, 1, 1, 1, c_white, alpha)
    else if (obj_player.movespeed >= 4.8 && obj_player.movespeed < 7.2 && (obj_player.state == (68 << 0) || obj_player.state == (69 << 0) || obj_player.state == (89 << 0) || obj_player.state == (16 << 0) || obj_player.state == (70 << 0) || obj_player.state == (36 << 0) || obj_player.state == (21 << 0)))
        draw_sprite_ext(spr_speedbar, 2, 125, 140, 1, 1, 1, c_white, alpha)
    else if (obj_player.movespeed >= 7.2 && obj_player.movespeed < 9.6 && (obj_player.state == (68 << 0) || obj_player.state == (69 << 0) || obj_player.state == (89 << 0) || obj_player.state == (16 << 0) || obj_player.state == (70 << 0) || obj_player.state == (36 << 0) || obj_player.state == (21 << 0)))
        draw_sprite_ext(spr_speedbar, 3, 125, 140, 1, 1, 1, c_white, alpha)
    else if (obj_player.movespeed >= 9.6 && obj_player.movespeed < 12 && (obj_player.state == (68 << 0) || obj_player.state == (69 << 0) || obj_player.state == (89 << 0) || obj_player.state == (16 << 0) || obj_player.state == (70 << 0) || obj_player.state == (36 << 0) || obj_player.state == (21 << 0)))
        draw_sprite_ext(spr_speedbar, 4, 125, 140, 1, 1, 1, c_white, alpha)
    else if (obj_player.movespeed >= 12 && (obj_player.state == (68 << 0) || obj_player.state == (69 << 0) || obj_player.state == (89 << 0) || obj_player.state == (16 << 0) || obj_player.state == (70 << 0) || obj_player.state == (36 << 0) || obj_player.state == (21 << 0)))
