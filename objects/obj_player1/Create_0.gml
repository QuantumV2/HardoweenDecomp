scr_initinput()
global.qolfeatures = true //disable for authentic hardoween experience
...
backtohubstartx = x
backtohubstarty = y
backtohubroom = halloween_entrance
global.style = 0
slapcharge = 0
slaphand = 1
slapbuffer = 8
