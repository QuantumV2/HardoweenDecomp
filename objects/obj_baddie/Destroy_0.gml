if (ds_list_find_index(global.baddieroom, id) == -1 && important == 0)
{
    ...
    with (instance_create(x, y, obj_sausageman_dead))
    {
        ...
        spr_palette = variable_instance_exists(other, "spr_palette") ? other.spr_palette : spr_null
        paletteselect = variable_instance_exists(other, "paletteselect") ? other.paletteselect : spr_null
    }
