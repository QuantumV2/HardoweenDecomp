...
if (obj_player2.state != (54 << 0))
{
    if (obj_player2.character == "P")
    {
        if (!((obj_player2.state == (68 << 0) || obj_player2.state == (22 << 0) || obj_player2.state == (53 << 0) || (obj_player2.state == (53 << 0) && obj_player2.sprite_index == spr_player_bossintro) || (obj_player2.state == (53 << 0) && obj_player2.sprite_index == spr_player_idle) || obj_player2.state == (26 << 0) || obj_player2.state == (36 << 0) || obj_player2.state == (35 << 0) || obj_player2.state == (32 << 0) || obj_player2.state == (37 << 0) || obj_player2.state == (41 << 0) || obj_player2.state == (91 << 0) || obj_player2.state == (45 << 0) || obj_player2.state == (46 << 0) || obj_player2.state == (50 << 0) || obj_player2.state == (47 << 0) || obj_player2.state == (48 << 0) || obj_player2.state == (49 << 0) || obj_player2.state == (56 << 0) || (obj_player2.state == (53 << 0) && obj_player2.sprite_index == spr_player_levelcomplete) || (obj_player2.state == (76 << 0) && shake_mag > 0) || obj_player2.state == (90 << 0) || obj_player2.state == (73 << 0) || obj_player2.state == (62 << 0) || obj_player2.state == (64 << 0) || obj_player2.state == (69 << 0) || obj_player2.state == (89 << 0) || obj_player2.state == (61 << 0) || obj_player2.state == (72 << 0) || obj_player2.state == (55 << 0) || obj_player2.sprite_index == spr_player_victory || obj_player2.state == (46 << 0))))
        {
        ...
        else if (obj_player2.state == (91 << 0) || (obj_player2.state == (76 << 0) && shake_mag > 0))
            draw_sprite_ext(spr_pepinoHUDstun, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player2.sprite_index == spr_player_victory || obj_player2.state == (55 << 0) || obj_player2.state == (61 << 0) || obj_player2.state == (22 << 0) || (obj_player2.state == (53 << 0) && obj_player2.sprite_index == spr_player_levelcomplete))
            draw_sprite_ext(spr_pepinoHUDhappy, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player2.state == (68 << 0) || obj_player2.state == (37 << 0) || obj_player2.state == (32 << 0) || obj_player2.state == (90 << 0) || obj_player2.state == (73 << 0) || obj_player2.state == (56 << 0) || obj_player2.state == (62 << 0) || obj_player2.state == (41 << 0) || obj_player2.state == (64 << 0) || obj_player2.state == (45 << 0) || obj_player2.state == (46 << 0) || obj_player2.state == (50 << 0) || obj_player2.state == (47 << 0) || obj_player2.state == (48 << 0) || obj_player2.state == (49 << 0))
            draw_sprite_ext(spr_pepinoHUDmach1, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player2.state == (69 << 0))
            draw_sprite_ext(spr_pepinoHUDmach2, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player2.state == (89 << 0) || obj_player2.state == (36 << 0))
            draw_sprite_ext(spr_pepinoHUDmach3, -1, 125, 100, 1, 1, 1, c_white, alpha)
        else if (obj_player2.state == (72 << 0) || obj_player2.state == (35 << 0) || obj_player2.state == (26 << 0) || (obj_player2.state == (53 << 0) && obj_player2.sprite_index == spr_player_bossintro) || (obj_player2.state == (53 << 0) && obj_player2.sprite_index == spr_player_idle))
