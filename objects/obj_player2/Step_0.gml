...
if (state == (40 << 0) || state == (46 << 0) || state == (47 << 0) || state == (49 << 0) || state == (48 << 0))
    ...
    grabbing = 0
if (state == (89 << 0) || state == (5 << 0) || state == (6 << 0) || state == (8 << 0) || state == (43 << 0) || state == (34 << 0) || state == (62 << 0) || state == (36 << 0) || state == (39 << 0) || state == (9 << 0) || (state == (42 << 0) && sprite_index == spr_piledriver) || state == (23 << 0) || state == (24 << 0) || state == (17 << 0) || state == (14 << 0) || state == (12 << 0) || state == (10 << 0))
    instakillmove = 1
else
    instakillmove = 0
...
if (state != (57 << 0))
    stompAnim = 0
if (state != (71 << 0) && state != (5 << 0) && state != (65 << 0) && state != (14 << 0) && state != (38 << 0) && sprite_index != spr_player_crouchshoot && state != (64 << 0) && state != (32 << 0) && state != (36 << 0) && state != (72 << 0) && state != (67 << 0) && state != (66 << 0))
    mask_index = spr_player_mask
else
    mask_index = spr_crouchmask
if (state == (22 << 0) || sprite_index == spr_knightpep_start || sprite_index == spr_knightpep_thunder || state == (55 << 0) || state == (77 << 0) || state == (3 << 0) || state == (63 << 0) || state == (60 << 0) || state == (54 << 0))
    cutscene = 1
else
    cutscene = 0
if ((place_meeting(x, y, obj_door) || place_meeting(x, y, obj_keydoor) || (place_meeting(x, y, obj_exitgate) && global.panic == 1)) && (!instance_exists(obj_uparrow)) && scr_solid(x, (y + 1)) && state == (0 << 0))
