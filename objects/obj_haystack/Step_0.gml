with (obj_peasanto)
{
    if (place_meeting((x + hsp), y, other.id) && state == (94 << 0) && other.sprite_index != spr_haystackburning && other.sprite_index != spr_haystackburningup)
...
if (sprite_index == spr_haystackburning && obj_player.state != (5 << 0) && obj_player.state != (23 << 0) && place_meeting(x, (y - 1), obj_player))
{
    obj_player.state = (5 << 0)
