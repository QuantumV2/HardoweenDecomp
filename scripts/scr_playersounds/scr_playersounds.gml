...
if (state == (68 << 0) && (!audio_is_playing(sfx_mach1)) && grounded)
    scr_soundeffect(sfx_mach1)
else if (state != (68 << 0) || (!grounded) || move == (-xscale))
    audio_stop_sound(sfx_mach1)
if ((sprite_index == spr_mach || state == (16 << 0)) && (!audio_is_playing(sfx_mach2)))
    scr_soundeffect(sfx_mach2)
else if (sprite_index != spr_mach && state != (16 << 0))
    audio_stop_sound(sfx_mach2)
if ((state == (89 << 0) || sprite_index == spr_mach3boost) && sprite_index != spr_crazyrun && (!audio_is_playing(sfx_mach3)))
    scr_soundeffect(sfx_mach3)
else if ((state != (89 << 0) && sprite_index != spr_mach3boost) || sprite_index == spr_crazyrun)
    audio_stop_sound(sfx_mach3)
if (state == (17 << 0) && (!audio_is_playing(sfx_knightslide)))
    scr_soundeffect(sfx_knightslide)
else if (state != (17 << 0) && audio_is_playing(sfx_knightslide))
...
if (state != (64 << 0) && audio_is_playing(sfx_superjumpprep))
    audio_stop_sound(sfx_superjumpprep)
if (state != (64 << 0) && audio_is_playing(sfx_superjumphold))
...
if (state != (1 << 0) && sprite_index != spr_machroll)
{
    audio_stop_sound(sfx_tumble1)
    audio_stop_sound(sfx_tumble2)
    audio_stop_sound(sfx_tumble3)
}
if (audio_is_playing(sfx_suplexdash) && state != (21 << 0))
