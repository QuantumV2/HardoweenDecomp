...
if (obj_player1.state == (27 << 0) || obj_player1.state == (45 << 0) || obj_player1.state == (40 << 0) || obj_player1.state == (41 << 0) || obj_player1.state == (9 << 0))
{
    x = obj_player1.x
...
with (obj_player1)
{
    ...
    if (!((state == (45 << 0) || state == (2 << 0) || state == (27 << 0) || state == (40 << 0) || state == (41 << 0) || state == (9 << 0) || state == (46 << 0) || state == (42 << 0) || state == (47 << 0) || state == (48 << 0) || state == (49 << 0))))
    {
        other.x = x
        other.y = y
        other.state = (104 << 0)
...
if (obj_player1.state == (2 << 0) && obj_player1.image_index < 5)
{
    x = (obj_player1.x + (obj_player1.xscale * 60))
    y = obj_player1.y
}
if (obj_player1.state == (47 << 0))
{
    alarm[3] = 3
    global.hit += 1
    if (other.object_index == obj_pizzaball)
...
if (obj_player1.state == (9 << 0))
{
    x = (obj_player1.x + (obj_player1.xscale * 15))
    y = obj_player1.y
}
if (obj_player1.state == (42 << 0) && obj_player1.sprite_index == obj_player1.spr_piledriver)
{
...
if (obj_player1.state == (45 << 0) && obj_player1.sprite_index == obj_player1.spr_swingding)
{
    if (floor(obj_player1.image_index) == 0)
    {
        depth = -8
